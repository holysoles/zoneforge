...
def zone(zone_name):
    ...
    primary_ns = zf_record.get(zone_name=zone_name, record_name='@', record_type='NS') #TODO need to be able to find by record_data
    primary_ns_a = zf_record.get(zone_name=zone_name, record_name=soa["data"]["primary_ns"], record_type='A')
    current_zone_data = {
        "name": zone_name,
        "soa_ttl": soa["ttl"],
